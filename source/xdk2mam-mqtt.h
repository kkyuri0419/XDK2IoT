...
#define WLAN_SSID 			"GlocalMe_67503"

#define WLAN_PSK			"68020509"

#define MQTT_BROKER_HOST	"192.168.43.170"


#define MQTT_BROKER_PORT	UINT16_C(1883) //<-- MQTT_PORT_BROKER

#define MQTT_USERNAME	"yuri"

#define MQTT_PASSWORD	"yuri0419"

#define DEVICE_NAME			"XDK2IoT"
...
#define TOPIC				"devices/XDKdevice/messages/events/"
